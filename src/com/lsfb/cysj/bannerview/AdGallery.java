...
import com.lsfb.cysj.IdeasWorldGameActivity;
import com.lsfb.cysj.bannerview.AdGalleryHelper.OnGallerySwitchListener;
...
//			bitmapUtils.display(viewHolder.imageview, mAds[position % mAds.length].getPicURL());
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			long arg3) {
		Intent i = new Intent();
		i.setClass(mContext, IdeasWorldGameActivity.class);
