...
public class TicketAlreadyoverdueFragment extends Fragment implements
		IXListViewListener {
	private View rootView;
	XListView listviewAlreadyoverdue;
...
//								Toast.LENGTH_SHORT).show();
					...
					listviewAlreadyoverdue.setAdapter(baseAdapter);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (rootView == null) {
			rootView = inflater.inflate(R.layout.ticket_alreadyoverdue,
					container, false);
		} else {
			...
			public View getView(final int position, View v, ViewGroup arg2) {
				...
				if (v == null) {
					...
					v = LayoutInflater.from(getActivity()).inflate(
							R.layout.listview_alreadyoverdue, null);
					holder.imageview = (ImageView) v
							.findViewById(R.id.ivlistViewAlreadyoverdue);
					holder.tvHead = (TextView) v
							.findViewById(R.id.tv_AlreadyoverdueHead);
					holder.tvaddress = (TextView) v
							.findViewById(R.id.tv_AlreadyoverdueAddress);
					holder.tvtime = (TextView) v
							.findViewById(R.id.tv_AlreadyoverdueTime);
					holder.tvmoney = (TextView) v
							.findViewById(R.id.tv_AlreadyoverdueMoney);
					v.setTag(holder);
				} else {
	...
	private void init() {
		// TODO Auto-generated method stub
		listviewAlreadyoverdue = (XListView) rootView.findViewById(R.id.listviewAlreadyoverdue);
		httpClient = IsTrue.HttpConnectionManager.getHttpClient();
		list = new ArrayList<Map<String, Object>>();
		bitmapUtils = new BitmapUtils(getActivity());
		listviewAlreadyoverdue.setPullLoadEnable(true);
		listviewAlreadyoverdue.setXListViewListener(this);
	}

	private void onLoad() {
		listviewAlreadyoverdue.stopRefresh();
		listviewAlreadyoverdue.stopLoadMore();
		listviewAlreadyoverdue.setRefreshTime("刚刚");
	}
