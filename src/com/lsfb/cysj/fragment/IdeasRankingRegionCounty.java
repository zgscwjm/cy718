...
import com.lsfb.cysj.fragment.IdeasRankingFirmFragment.ViewHolder;
...
public class IdeasRankingRegionCounty extends Fragment implements
		IXListViewListener {
...
//								Toast.LENGTH_SHORT).show();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (rootView == null) {
			rootView = inflater.inflate(R.layout.ideas_ranking_region_county,
					container, false);
		} else {
	...
	public void init() {
		...
		listview = (XListView) rootView
				.findViewById(R.id.ideas_ranking_region_county_list);
			...
			public void run() {
				try {
					...
					HttpPost post = new HttpPost(
							MyUrl.StringzhishuRankingdiqu);

					List<NameValuePair> params = new ArrayList<NameValuePair>();

					params.add(new BasicNameValuePair("uid", IsTrue.userId + ""));
					params.add(new BasicNameValuePair("cid","4"));
		...
		new Thread() {
			...
			public void run() {
				try {
					...
					HttpPost post = new HttpPost(
							MyUrl.StringzhishuRankingdiqus);
