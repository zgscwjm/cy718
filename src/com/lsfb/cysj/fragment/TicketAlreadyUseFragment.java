...
public class TicketAlreadyUseFragment extends Fragment implements IXListViewListener{
	private View rootView;
	XListView listviewAlreadyUse;
...
//								Toast.LENGTH_SHORT).show();
					...
					listviewAlreadyUse.setAdapter(baseAdapter);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (rootView == null) {
			rootView = inflater
					.inflate(R.layout.ticket_alreadyuse, container, false);
		} else {
				...
				if (v == null) {
					...
					v = LayoutInflater
							.from(getActivity()).inflate(
									R.layout.listview_alreadyuse, null);

					holder.imageview = (ImageView) v
							.findViewById(R.id.ivlistViewAlreadyUse);
					holder.tvHead = (TextView) v
							.findViewById(R.id.tv_AlreadyHead);
					holder.tvaddress = (TextView) v
							.findViewById(R.id.tv_AlreadyAddress);
					holder.tvtime = (TextView) v
							.findViewById(R.id.tv_AlreadyTime);
					holder.tvmoney = (TextView) v
							.findViewById(R.id.tv_Alreadymoeny);
					v.setTag(holder);
				} else {
	...
	private void init() {
		// TODO Auto-generated method stub
		listviewAlreadyUse = (XListView) rootView.findViewById(R.id.listviewAlreadyUse);
		httpClient = IsTrue.HttpConnectionManager.getHttpClient();
		list = new ArrayList<Map<String, Object>>();
		bitmapUtils = new BitmapUtils(getActivity());
		listviewAlreadyUse.setPullLoadEnable(true);
		listviewAlreadyUse.setXListViewListener(this);
	}

	private void onLoad() {
		listviewAlreadyUse.stopRefresh();
		listviewAlreadyUse.stopLoadMore();
		listviewAlreadyUse.setRefreshTime("刚刚");
	}
