...
import com.lsfb.cysj.fragment.ScienceAwardFragment.ViewHolder;
import com.lsfb.cysj.view.ResDialog;

/**
 * 艺术奖
 */
public class ArtPrizeFragment extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (rootView == null) {
			rootView = inflater.inflate(R.layout.artprize, container, false);
		} else {
...
//			initdata();
	...
	private void initdata() {
		...
		client.post(MyUrl.yxcguo, params, new JsonHttpResponseHandler(){
			...
			public void onSuccess(int statusCode, Header[] headers,
				...
				System.out.println(listmap+"OOOOO");
	...
	private void init() {
		list = (ListView) rootView.findViewById(R.id.artprize_list);
		text = (TextView) rootView.findViewById(R.id.artprize_list_text);
		map = new HashMap<String, Object>();
