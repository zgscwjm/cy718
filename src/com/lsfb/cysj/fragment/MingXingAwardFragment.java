...
public class MingXingAwardFragment extends Fragment implements OnClickListener {
	private static String[] names = new String[] { "赵大宝", "赵大宝", "赵大宝", "赵大宝",
			"赵大宝", "赵大宝", "赵大宝", "赵大宝", "赵大宝", "赵大宝", "赵大宝", "赵大宝", "赵大宝",
			"赵大宝", "赵大宝" };
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (rootView == null) {
			rootView = inflater.inflate(R.layout.goodness_award, container,
					false);
		} else {
...
//			initdata();
	...
	private void initdata() {
		...
		client.post(MyUrl.yxcguo, params, new JsonHttpResponseHandler(){
			...
			public void onSuccess(int statusCode, Header[] headers,
				...
				System.out.println(response+"JJJ");
				try {
	...
	private void date() {
		adapter = new BaseAdapter() {
			...
			public View getView(final int position, View convertView, ViewGroup parent) {
				...
				if (convertView == null) {
					convertView = LayoutInflater.from(getActivity()).inflate(R.layout.goodness_award_list_item, null);
					holder = new ViewHolder();
					holder.img = (ImageView) convertView.findViewById(R.id.goodness_award_list_item_img);
					holder.name = (TextView) convertView.findViewById(R.id.goodness_award_list_item_head);
					holder.num = (TextView) convertView.findViewById(R.id.goodness_award_list_num);
					holder.button = (Button) convertView.findViewById(R.id.goodness_award_list_item_button);
				...
				holder.name.setText(listmap.get(position).get("name").toString());
	...
	private void init() {
		list = (ListView) rootView.findViewById(R.id.goodness_award_list);
		text = (TextView) rootView.findViewById(R.id.goodness_award_list_text);
		map = new HashMap<String, Object>();
