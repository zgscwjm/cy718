...
import com.lsfb.cysj.fragment.IdeasRankingRegionCounty.ViewHolder;
...
public class IdeasRankingRegionCountry extends Fragment implements
		IXListViewListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (rootView == null) {
			rootView = inflater.inflate(R.layout.ideas_ranking_region_country,
					container, false);
		} else {
	...
	public void date() {
		baseAdapter = new BaseAdapter() {
			...
			public View getView(final int position, View v, ViewGroup parent) {
				...
				bitmapUtils.display(holder.tvimage, ImageAddress.Stringarea
	...
	public void init() {
		...
		listview = (XListView) rootView
				.findViewById(R.id.ideas_ranking_region_country_list);
