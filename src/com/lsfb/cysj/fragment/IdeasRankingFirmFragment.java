...
import com.lsfb.cysj.fragment.IdeasRankingGovFragment.ViewHolder;
import com.lsfb.cysj.view.XListView;
import com.lsfb.cysj.view.XListView.IXListViewListener;

public class IdeasRankingFirmFragment extends Fragment implements
IXListViewListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (rootView == null) {
			rootView = inflater
					.inflate(R.layout.ideas_ranking_firm, container, false);
		} else {
	...
	public void init() {
		num = (TextView) rootView.findViewById(R.id.ideas_ranking_firm_num);

		listview = (XListView) rootView
				.findViewById(R.id.ideas_ranking_firm_list);
		...
		new Thread() {
			...
			public void run() {
				try {
					...
					params.add(new BasicNameValuePair("cla","3"));
