...
import com.lsfb.cysj.fragment.CreativeFragment.ViewHolder;
import com.lsfb.cysj.view.ResDialog;
import com.lsfb.cysj.view.XListView;
import com.lsfb.cysj.view.XListView.IXListViewListener;

public class CreativeFragments extends Fragment implements IXListViewListener {
	...
	String classs = "";// class: 1(个人)|2(他人)谁点击进来的
	String uid = "0";
	String mid = "0";
...
//								Toast.LENGTH_SHORT).show();
	...
	public void changeclass(String classs, String uid, String mid) {
		this.classs = classs;
		this.uid = uid;
		this.mid = mid;
		chushihua();
		...
		new Thread() {
			...
			public void run() {
				try {
					...
					HttpPost post = new HttpPost(MyUrl.StringchuangyiMy);
					...
					System.err.println(IsTrue.userId + "++++" + classs);
		...
		new Thread() {
			...
			public void run() {
				try {
					...
					HttpPost post = new HttpPost(MyUrl.StringchuangyiMys);
