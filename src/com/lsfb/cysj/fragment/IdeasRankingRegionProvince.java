...
import com.lsfb.cysj.fragment.IdeasRankingRegionCountry.ViewHolder;
...
public class IdeasRankingRegionProvince extends Fragment implements
		IXListViewListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (rootView == null) {
			rootView = inflater.inflate(R.layout.ideas_ranking_region_province,
					container, false);
		} else {
	...
	public void init() {
		...
		listview = (XListView) rootView
				.findViewById(R.id.ideas_ranking_region_province_list);
