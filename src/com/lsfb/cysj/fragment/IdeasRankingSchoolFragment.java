...
import com.lsfb.cysj.fragment.IdeasRankingFriendsFragment.ViewHolder;
import com.lsfb.cysj.view.XListView;
import com.lsfb.cysj.view.XListView.IXListViewListener;

public class IdeasRankingSchoolFragment extends Fragment implements
		IXListViewListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (rootView == null) {
			rootView = inflater.inflate(R.layout.ideas_ranking_school,
					container, false);
		} else {
	...
	public void date() {
		baseAdapter = new BaseAdapter() {
			...
			public View getView(int position, View v, ViewGroup parent) {
				...
				bitmapUtils.display(holder.tvimage, ImageAddress.Stringinstitutions
						+ list.get(position).get("image").toString());
				holder.tvname.setText(list.get(position).get("name")
						.toString());
	...
	public void init() {
		num = (TextView) rootView.findViewById(R.id.ideas_ranking_school_num);

		listview = (XListView) rootView
				.findViewById(R.id.ideas_ranking_school_list);
			...
			public void run() {
				try {
					...
					HttpPost post = new HttpPost(
							MyUrl.StringzhishuRankingSchool);

					List<NameValuePair> params = new ArrayList<NameValuePair>();

					params.add(new BasicNameValuePair("uid", IsTrue.userId + ""));
					params.add(new BasicNameValuePair("cla","1"));
		...
		new Thread() {
			...
			public void run() {
				try {
					...
					HttpPost post = new HttpPost(
							MyUrl.StringzhishuRankingSchools);
