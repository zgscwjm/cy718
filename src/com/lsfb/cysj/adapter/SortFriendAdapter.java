...
public class SortFriendAdapter extends BaseAdapter implements SectionIndexer {
	...
	public SortFriendAdapter(Context mContext, List<SortModel> list) {
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		if (view == null) {
			...
			view = LayoutInflater.from(mContext).inflate(R.layout.friendfriend,
					null);
			viewHolder.tvTitle = (TextView) view
					.findViewById(R.id.friends_friends_item_title);
			viewHolder.tvLetter = (TextView) view
					.findViewById(R.id.friends_friends_item_catalog);
			viewHolder.img = (ImageView) view
					.findViewById(R.id.friends_friends_item_img);
			viewHolder.guanzhu = (Button) view
					.findViewById(R.id.friends_friends_item_guanzhu);
		...
		bitmapUtils.display(viewHolder.img, ImageAddress.Stringhead
				+ this.list.get(position).getImage());
		viewHolder.tvTitle
