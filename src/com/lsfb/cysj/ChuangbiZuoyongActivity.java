 ...
 *
 */
public class ChuangbiZuoyongActivity extends Activity {
...
//				num:1
				...
				try {
					...
					if(!TextUtils.isEmpty(url)){
						webZuoyong.loadUrl(url);
						webZuoyong.getSettings().setJavaScriptEnabled(true);
					}
...
//					}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_chuangbi_zuoyong);
		init();
		...
		new Thread() {
			...
			public void run() {
				try {
					...
					HttpPost post = new HttpPost(MyUrl.ZuoyongMychuangchuang);
...
//		tv_AboutUs = (TextView) findViewById(R.id.tv_AboutUs);
		webZuoyong = (WebView) findViewById(R.id.webZuoyong);
	}
